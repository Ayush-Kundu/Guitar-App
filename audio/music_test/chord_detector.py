...
def parse_args():
    ...
    parser.add_argument('--log-interval', type=float, default=0.3, help='Logging interval in seconds (default: 0.5)')
    parser.add_argument('--progression', action='store_true', default=True, help='Enable chord progression analysis (default: enabled)')
    parser.add_argument('--sensitivity', type=float, default=0.8, help='Detection sensitivity (0.1-2.0, default: 1.0)')
